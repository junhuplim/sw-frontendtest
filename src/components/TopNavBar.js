    ...
    <React.Fragment>
      <ThemeProvider theme={theme}>
        <Grid container className={classes.container}>
          <Grid md={1} className={classes.company}>
            NARWHAL
          </Grid>
          <Divider orientation="vertical" flexItem />
          <Grid container md={10} className={classes.menu}>
            <Typography className={classes.header}>Teams</Typography>
            <Grid container md={3} className={classes.profile}>
        ...
        <Grid container className={classes.box}>
          ...
          <Grid container md={3} className={classes.textfieldBox}>
            <SearchIcon />
            <TextField
              id="search"
